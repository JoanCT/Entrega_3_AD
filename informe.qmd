...
<jct> Desciben el contexto del problema
; Desciben cada una de las vaiables que confoman la base de datos del estudio
 ; Han explicado adecuadamente la metodología estadística que se utiliza en el estudio </jct>
...
<jct>Pq al boxplot comences a comptar pel 2 en lloc de l'1 ? Pq tengui sentit amb es gràfic ts, han de sortir 1 i 3 alts, en lloc de 2 i 4, no?</jct>
```{r}
...
<jct>Provant de començar a comptar per 1</jct>
...
<jct>Tendria sentit que fos això darrer que comentes. Demà li demanam si només se referia a això o a models més elaborats (però q ns on emplearien es models additius / multiplcatius) </jct>
