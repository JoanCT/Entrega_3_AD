...
## Continguts
- Enunciat
- Introducció <todo></todo>
- Anàlisi exploratòria
- Models additiu i multiplicatiu <todo>Mirau ses notes que he posat</todo>
- Prediccions <todo></todo>
- Conclusions <todo></todo>
...
## Comparativa (I)
<gra>Això ja és des model simplificat. Ho posam abans d'aquesta diapo o ho deim allà?</gra>
<gra>També hauríem de mostrar lo que mos dona es model per veure a ull que sa variança des residus es sa mateixa. Jo proòs no posar es `decompose()` d'abans pq total no els feim servir i dibuixar es simplificats, dient a sa presentació que no mos serveixen pq no podem fer prediccions</gra>
```{r}
